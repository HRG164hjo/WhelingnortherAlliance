...
namespace WNA.Recipe
{
    public class Inspection : Recipe_Surgery
    {
        ...
        {
            TaggedString label = "WNA_Inspection_LetterLabel".Translate();
            ...
            if (visible.Any())
            {
                sb.AppendLine("WNA_Inspection_Visible".Translate(pawn.Named("PAWN")));
            ...
            if (hidden.Any())
            {
                sb.AppendLine("WNA_Inspection_Hidden".Translate(pawn.Named("PAWN")));
            ...
            if (visible.Any() || hidden.Any())
            {
                ...
                Find.LetterStack.ReceiveLetter(label,
                    "WNA_Inspection_None".Translate(pawn.Named("PAWN")),
